...
using UnityEngine.UI;
     ...
     */
        ...
        public void OpenCharacterScreen()
        {
            ...
            damageStatPoints.text = globalPlayerInfo.GetDamage().ToString(CultureInfo.CurrentCulture) + "%";
            staminaStatPoints.text = globalPlayerInfo.GetMaxStamina().ToString(CultureInfo.CurrentCulture);
            ...
            expToLevel.text = (globalPlayerInfo.GetLevelThreshold() * globalPlayerInfo.GetLevel() * 1.3f -
                               globalPlayerInfo.GetExperience()).ToString(CultureInfo.CurrentCulture);
