        ...
        public override void Use(ItemBase itemBase)
        {
            ...
            if (globalPlayerInfo.GetStamina() > belongingTo.GetStamina && canAttack)
            {
                ...
                StartCoroutine(WaitToAttack(
                    animator.GetCurrentAnimatorStateInfo(animator.GetLayerIndex("Spear Attack")).length /
                    animator.GetCurrentAnimatorStateInfo(animator.GetLayerIndex("Spear Attack")).speed));
            }
        }
